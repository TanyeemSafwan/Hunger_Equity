...
public class DonorChangePassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passOld=(EditText) findViewById(R.id.donor_change_password_old);
        passNew=(EditText) findViewById(R.id.donor_change_password_new);
        passConfirm=(EditText) findViewById(R.id.donor_change_password_new2);
        confirm=(Button)findViewById(R.id.donor_password_change);
        eyeOld= (ImageButton) findViewById(R.id.donor_change_eye_1);
        eyeNew= (ImageButton) findViewById(R.id.donor_change_eye_2);
        eyeConfirm= (ImageButton) findViewById(R.id.donor_change_eye_2_2);

        Toast.makeText(DonorChangePassword.this, "Under Construction!", Toast.LENGTH_SHORT).show();
